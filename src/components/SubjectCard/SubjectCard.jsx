...
const SubjectCard = () => {
  return (
    <div className=' container py-1 md:py-24'>
        
        {/* header section */}
        <div className=' space-y-4 p-6 text-center max-w-[600px] mx-auto mb-5'>
            <h1 className=' uppercase font-semibold text-orange-600'>Our tutor subjects</h1>
            <p className=' font-semibold text-3xl'>Find Tutor in Any Subjects</p>
        </div>
        {/* card section */}
        <div className=' grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6'>
            {
                subjectList.map((subject)=>{
                    return (
                        ...
                        className=' border rounded-lg border-secondary/20 p-4 flex justify-start items-center gap-4
