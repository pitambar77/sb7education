...
const Data = [
    {
        ...
        desc:"All of our special education exports have a degree in special education.",
        icon:<GrYoga/>,
        bgColor:"#0063ff",
        delay:0.3,
    },
    ...
    {
        id:3,
        title:"Interactive Whitebord",
        desc:"Our digital whitebord equipped with audio and video chat fetures.",
        icon:<GiGymBag/>,
        bgColor:"#fa6400",
        delay:0.9,
    },
        ...
        <div className=' container py-24'>
            ...
            <div>
                <div className=' space-y-4 p-6 text-center max-w-[500px] mx-auto mb-5'>
                    ...
                    <p className=' font-semibold text-3xl '>Benefits of tutoring services with us</p>
                </div>
            </div>
            {/* card section */}
